...
/**
 * Created by pcdalao on 2017/9/19.
 * 封装为view的形式供其他调用
 */

public class CombinedCharView extends CombinedChart {
    private CombinedChart combineChart;
    public  Context context;

    public CombinedCharView(Context context){
        super(context);
    ...
    public CombinedCharView(Context context, AttributeSet attributes){
    ...
    public void settingCombineChart(ArrayList lineValues){
        ...
        MyMarkerView mv = new MyMarkerView(context, R.layout.pop);
